...
func _ready():
	...
	# Load and assign map textures for shader color modes
	var heading_map_tex = load("res://particle_shader/heading_map.png")
	var friend_map_tex = load("res://particle_shader/friend_map.png")
	var detection_map_tex = load("res://particle_shader/detection_map.png")
	$BoidParticles.process_material.set_shader_parameter("heading_map", heading_map_tex)
	$BoidParticles.process_material.set_shader_parameter("friend_map", friend_map_tex)
	$BoidParticles.process_material.set_shader_parameter("detection_map", detection_map_tex)
	...
	if SIMULATE_GPU:
		...
		$BoidParticles.process_material.set_shader_parameter("boid_data", boid_data_texture_rd)
